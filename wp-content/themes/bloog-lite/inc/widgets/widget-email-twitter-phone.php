                ...
                <div class="email-twitter-phone-section-wrap">
                    <?php // if(!empty($feat_page_title)) : ?>
                        <div class="bloog_img_title_twitter_wrap">
                            ...
                            <a class="bloog-email-title" href="mainto:<?php echo esc_attr($bloog_email_link); ?>"><?php echo esc_html($bloog_email_title); ?></a>
                        </div>
                        <div class="bloog_img_title_twitter_wrap">
                            <a href="https://twitter.com/<?php echo $bloog_twitter_link; ?>" target="_blank"><img src="<?php echo esc_url($bloog_twitter_image); ?>"/></a>
                            <a class="bloog-email-title" href="https://twitter.com/<?php echo $bloog_twitter_link; ?>" target="_blank"><?php echo esc_html($bloog_twitter_title); ?></a>
                        </div>
                        <div class="bloog_img_title_twitter_wrap">
                            <img src="<?php echo esc_url($bloog_phone_image); ?>"/>
                            <a class="bloog-email-title" href="#"><?php echo esc_html($bloog_phone_title); ?></a>
                        </div>
                    <?php // endif; ?>
                </div>
            <?php
