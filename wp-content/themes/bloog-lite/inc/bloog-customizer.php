...
$wp_customize -> add_section(
    ...
    array(
        'title' => __('Post Settings','bloog-lite'),
        'priority' => 20,
        'panel' => 'single_page_setting_panel'
        )
    );
...
// post date
$wp_customize -> add_setting(
    'single_post_date_option_setting',
    array(
        'default' => 'show',
        'sanitize_callback' => 'bloog_lite_sanitize_page_def_radio'
        )
    ); 

    // function bloog_lite_to sanitize background pattern
function bloog_lite_sanitize_page_def_radio($input){
    $valid_keys = array(
       'show' => __('Show ','bloog-lite'),
       'hide' => __('Hide -','bloog-lite'),
       );
    if ( array_key_exists( $input, $valid_keys)) {
       return $input;
   } else {
...
$wp_customize -> add_control(
    'single_post_date_option_setting',
    array(
        'label' => __('Show/Hide Post Date', 'bloog-lite'),
        'section' => 'single_post_settings_section',
        'type' => 'radio',
        'choices' => array(
            'show' => __('Show','bloog-lite'),
            'hide' => __('Hide','bloog-lite'),
...
// featured image
$wp_customize -> add_setting(
    'single_post_img_option_setting',
    array(
        'default' => 'show',
        'sanitize_callback' => 'bloog_lite_sanitize_page_def_radio'
        )
...
$wp_customize -> add_control(
    'single_post_img_option_setting',
    array(
        'label' => __('Show/Hide Featured Image', 'bloog-lite'),
        'section' => 'single_post_settings_section',
        'type' => 'radio',
        'choices' => array(
            'show' => __('Show','bloog-lite'),
...
// featured categories
$wp_customize -> add_setting(
    'single_post_cat_option_setting',
    array(
        'default' => 'show',
        'sanitize_callback' => 'bloog_lite_sanitize_page_def_radio'
        )
...
$wp_customize -> add_control(
    'single_post_cat_option_setting',
    array(
        'label' => __('Show/Hide Post Categories', 'bloog-lite'),
        'section' => 'single_post_settings_section',
        'type' => 'radio',
        'choices' => array(
            'show' => __('Show','bloog-lite'),
