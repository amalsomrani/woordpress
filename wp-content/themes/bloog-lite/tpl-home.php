            ...
            if(!empty($bloog_arr_category)){
                ...
                if($bloog_home_posts -> have_posts()){
                    ...
                    <div class="home_pagination_link">
                        <div class="older_pagination_home"><?php next_posts_link(esc_html__('Older Entries','bloog-lite'), $bloog_home_posts->max_num_pages ); ?></div>
                        <div class="new_pagination_home"><?php previous_posts_link(esc_html__('Newer Entries','bloog-lite')); ?> </div>
